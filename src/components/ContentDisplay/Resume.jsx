...
const Resume = () => {
  return (
      <ResumeStyled>
        ...
        <ul>
          <li>Built a full stack web app from scratch</li>
          <li>Managed software packages with NPM and the project through Github</li>
          <li>Deploying app on Heroku</li>
        </ul>
        <h4>QC/QA Team Leader&nbsp;<br />@&nbsp;AmTran&nbsp;[ Chino, CA ]</h4>
        <p>Mar 2018 – May 2019</p>
        <ul>
          <li>Attained TV and Sound Bar refurbish permission by passing quality audit from VIZIO</li>
          <li>Reduced 50% of Work-in-Progress (WIP) storage</li>
        </ul>
        <h4>Electrical Engineer&nbsp;<br />@&nbsp;AmTran&nbsp;[ Taipei, Taiwan ]</h4>
        <p>Oct 2009 – Oct 2013</p>
        <ul>
          <li>Developed, created and maintained mainboard system schematic and PCB layout for TVs</li>
          <li>Resolved products problems and issues from design to production</li>
        </ul>
        <Section>
          <h2>Education</h2>
          <h4>Udemy Courses</h4>
          ...
          <ul>
            <li>Design and tape-out a PWM Class D Audio Amplifier IC</li>
            <li>GPA: 4.0 / 4.0</li>
          </ul>
